...
var generator = function(time, name, school, id){
    ...
    var passage_rule_1 = {width:500, align: 'left', characterSpacing :3, lineGap: 5, paragraphGap: 5};
    ...
    const PASSAGE3_1 = '本测验采用迫选测量方式共32组题目平均用时' + time + '分钟。测验结果提供一个对教师心理8项特征的快速考察。您的测试结果如下图:';
    ...
    const PASSAGE4_4_1 = '高分特征：教师在教育教学过程中敏感于学生的主体性，利用各种教育情境创建各种方法引导、激发学生自主性。';
    const PASSAGE4_5 = '5． 情绪成熟度: 教师日常及处理与学生关系过程中表现的情绪特征';
    const PASSAGE4_5_1 = '高分特征：教师具有稳定、积极的情绪特征。有高水平幸福感。习惯用成熟和负责任的方式处理与学生的关系及突发事件。';
    ...
    const PASSAGE4_7_1 = '高分特征：教师掌握有效的情绪调控策略，并在与学生的互动过程中保持对自己进行情绪的有效调节。';
    const PASSAGE4_8 = '8．压力应对：教师如何应对教育工作中的负荷和挑战';
    const PASSAGE4_8_1 = '高分特征：教师能承担教学教育工作带来的高负荷，面对教育情境中的各种挑战、困难、挫折和失败能找到缓解自己压力的措施与方法。';
    ...
    doc.image(__dirname + '/chart.png',80,300,{width:300, height:200});
    doc.font(__dirname + '/fonts/msyh.ttf')
        .fontSize(10)
        .text('    ' + PASSAGE3_2,80, 600, passage_rule)
    doc.font(__dirname + '/fonts/msyh.ttf')
        .fontSize(10)
        .text('    ' + PASSAGE3_3,80, 620, passage_rule)
    doc.roundedRect(60,595,520,70,12).lineWidth(3).stroke('yellow');
    ...
    doc.font(__dirname + '/fonts/msyh.ttf')
        .fontSize(12)
        .text('    ' + PASSAGE4_1_1,passage_rule_1);  
    ...
    doc.font(__dirname + '/fonts/msyh.ttf')
        .fontSize(12)
        .text('     ' + PASSAGE4_2_1,passage_rule_1);  
    ...
    doc.font(__dirname + '/fonts/msyh.ttf')
        .fontSize(12)
        .text('    ' + PASSAGE4_3_1,passage_rule_1); 
    ...
    doc.font(__dirname + '/fonts/msyh.ttf')
        .fontSize(12)
        .text('    ' + PASSAGE4_4_1,passage_rule_1); 
    ...
    doc.font(__dirname + '/fonts/msyh.ttf')
        .fontSize(12)
        .text('    ' + PASSAGE4_5_1,passage_rule_1); 
    ...
    doc.font(__dirname + '/fonts/msyh.ttf')
        .fontSize(12)
        .text('    ' + PASSAGE4_6_1,passage_rule_1); 
    ...
    doc.font(__dirname + '/fonts/msyh.ttf')
        .fontSize(12)
        .text('    ' + PASSAGE4_7_1,passage_rule_1); 
    ...
    doc.font(__dirname + '/fonts/msyh.ttf')
        .fontSize(12)
        .text('    ' + PASSAGE4_8_1,passage_rule_1); 
